...
export const CONTRACT_ABI = [
  "function createPolicy(address _contractInsured, uint256 _coverageAmount, uint256 _durationDays, string memory _riskLevel) external payable returns (uint256)",
  "function renewPolicy(uint256 _policyId, uint256 _durationDays) external payable",
  "function getPolicyDetails(uint256 _policyId) external view returns (address owner, address contractInsured, uint256 coverageAmount, uint256 premiumRate, uint256 expirationDate, bool active)",
  "function fileClaim(uint256 _policyId, uint256 _claimAmount, string memory _description) external returns (uint256)",
  "function getClaimDetails(uint256 _claimId) external view returns (address claimant, uint256 policyId, uint256 claimAmount, string memory description, uint8 status, uint256 timestamp)",
  "function getStats() external view returns (uint256 totalPolicies, uint256 totalClaims, uint256 premiumsCollected, uint256 claimsPaid, uint256 balance)",
  "function cancelPolicy(uint256 _policyId) external",
  "function policies(uint256 _policyId) external view returns (address owner, address contractInsured, uint256 coverageAmount, uint256 premiumRate, uint256 expirationDate, bool active)",
...
const CONTRACT_ADDRESSES: Record<number, string> = {
  ...
  11155111: '0x0000000000000000000000000000000000000000', // Sepolia testnet - replace with your contract address
